...
from tests.dispatcher.dispatcher.helpers import EditedChannelPostHandler, EditedChannelPostFilter
...
def test(
    ...
    assert dispatcher.check_edited_channel_post_handler(handler, filter_, rate_limit) is False

    dispatcher.add_edited_channel_post_handler(handler, filter_, rate_limit)

    assert dispatcher.check_edited_channel_post_handler(handler, filter_, rate_limit) is True
