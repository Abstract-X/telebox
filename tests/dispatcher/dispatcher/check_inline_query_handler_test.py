...
from tests.dispatcher.dispatcher.helpers import InlineQueryHandler, InlineQueryFilter
...
def test(
    ...
    assert dispatcher.check_inline_query_handler(handler, filter_, rate_limit) is False

    dispatcher.add_inline_query_handler(handler, filter_, rate_limit)

    assert dispatcher.check_inline_query_handler(handler, filter_, rate_limit) is True
