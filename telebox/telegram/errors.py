...
@dataclass
class TelegramError(TeleboxError):
    """General class for Telegram errors."""


@dataclass
class UnknownMessageTypeError(TelegramError):
    """Class for unknown message type errors."""


@dataclass
class RequestError(TelegramError):
    """Class for Telegram Bot API request errors."""
    DEFAULT_TEMPLATE = "\n".join((
