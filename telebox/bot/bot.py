...
from typing import Union, Literal, Optional, BinaryIO
        ...
        *,
        ...
        data = self._session.send_request(
            ...
            parameters={
                ...
                "parse_mode": self._get_parse_mode(parse_mode, entities),
                "entities": entities,
                "link_preview_options": self._get_link_preview_options(link_preview_options),
                "disable_notification": self._get_disable_notification(disable_notification),
                "protect_content": self._get_protect_content(protect_content),
        ...
        *,
        ...
        data = self._session.send_request(
            ...
            parameters={
                ...
                "video_start_timestamp": video_start_timestamp,
                "caption": caption,
                "parse_mode": self._get_parse_mode(parse_mode, caption_entities),
        ...
        *,
        ...
        data = self._session.send_request(
            ...
            parameters={
                ...
                "business_connection_id": business_connection_id,
                "message_thread_id": message_thread_id,
                "question_parse_mode": self._get_parse_mode(question_parse_mode, question_entities),
                ...
                "explanation_parse_mode": self._get_parse_mode(explanation_parse_mode, explanation_entities),
        ...
        *,
        ...
        data = self._session.send_request(
            ...
            parameters={
                ...
                "text": text,
                "text_parse_mode": self._get_parse_mode(text_parse_mode, text_entities),
